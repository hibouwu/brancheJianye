...
# 保留整个 Shadow Runtime 的核心类
-keep class com.tencent.shadow.core.runtime.** { *; }
-keep class com.tencent.shadow.core.loader.** { *; }

# 特别保留 DelegateProviderHolder
-keep class com.tencent.shadow.core.runtime.container.DelegateProviderHolder { *; }

# 保留所有通过反射创建的插件 Activity/Service/Provider
